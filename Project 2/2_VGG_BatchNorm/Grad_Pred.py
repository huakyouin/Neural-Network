...
def plot_loss_landscape(iteration,VGG_A_max_curve,
    ...
    savepath=Seek_dir('exp')+'/Grad_Pred_VGG_Cmp_BN.png'
...
if __name__ == '__main__':
    ...
    for lr in lrs:
        ...
        VGG_A_dists.append(train(model, optimizer, criterion, train_loader, val_loader, epochs_n=epoch_num))
        
        model = VGG_A_BatchNorm()
        optimizer = torch.optim.Adam(model.parameters(), lr=lr)
        criterion = nn.CrossEntropyLoss()
        VGG_A_BN_dists.append(train(model, optimizer, criterion, train_loader, val_loader, epochs_n=epoch_num))
