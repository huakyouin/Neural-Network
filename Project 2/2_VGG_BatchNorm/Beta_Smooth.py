...
def plot_beta(iteration,VGG_A_curve,VGG_A_BN_curve):
    ...
    savepath=Seek_dir('exp')+'/Beta_Smoothness.png'
...
if __name__ == '__main__':
    ...
    for lr in lrs:
        ...
        VGG_A_betas.append(train(model, optimizer, criterion, train_loader, val_loader, epochs_n=epoch_num))
        
        model = VGG_A_BatchNorm()
        optimizer = torch.optim.Adam(model.parameters(), lr=lr)
        criterion = nn.CrossEntropyLoss()
        VGG_A_BN_betas.append(train(model, optimizer, criterion, train_loader, val_loader, epochs_n=epoch_num))
